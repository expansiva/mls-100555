/// <mls fileReference="_100555_/l2/utils/collabEditMd.ts" enhancement="_102027_/l2/enhancementLit" />
...
@customElement('utils--collab-edit-md-100555')
export class CollabEditMd extends LitElement {
    ...
    private onOpenedChanged(value: boolean) {
        ...
        if (!this.containerEditor) return;
        const toolbar = this.containerEditor.querySelector('.editor-toolbar') as HTMLElement;
    ...
    private onEditClick() {
        if (this.iconFinish) this.iconFinish.style.display = '';
        if (this.iconEdit) this.iconEdit.style.display = 'none';
    ...
    private onFinishClick() {
        if (this.iconEdit) this.iconEdit.style.display = '';
        if (this.iconFinish) this.iconFinish.style.display = 'none';
        const isPreviewActive = this.editor.isPreviewActive();
        if (!isPreviewActive) this.editor.togglePreview();
